...
import { collection, getDocs, addDoc, setDoc, doc, deleteDoc, query, orderBy, onSnapshot } from 'firebase/firestore';
...
export default function Collections() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      {/* Categories listings grid table */}
