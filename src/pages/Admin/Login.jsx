...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4 relative">
      <Link 
        to="/" 
        className="absolute top-6 left-6 flex items-center gap-2 text-sm uppercase tracking-wider font-semibold text-neutral-600 hover:text-primary transition-all duration-300"
      >
        <ArrowLeft size={18} />
        Back to Website
      </Link>
      ...
      <div className="max-w-md w-full bg-white p-8 rounded shadow-premium border-t-4 border-primary">
        ...
        <div className="mt-6 text-center text-xs text-neutral-400 leading-relaxed">
          ...
          <p className="mt-2 text-primary font-medium">Offline Testing User: admin@bonitashop.com / admin@bonitaropita.com <span className="text-neutral-400 font-normal">with</span> password123</p>
        </div>
